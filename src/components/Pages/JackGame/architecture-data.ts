...
export const archLayers: ArchLayer[] = [
  {
    ...
    blurb: 'The game running above — written in Jack, an object-based language.',
  ...
  },
  {
    ...
    blurb: 'Compiles the object-based Jack language down to stack-based VM code.',
  ...
  },
  {
    ...
    blurb: 'Turns the stack-based virtual machine language into Hack assembly.',
  ...
  },
  {
    ...
    blurb: 'Translates assembly mnemonics into 16-bit binary machine code.',
  ...
  },
  {
    ...
    blurb: 'A standard library in Jack: graphics, math, memory, strings and I/O.',
  ...
  },
  {
    ...
    blurb: 'Wires the CPU to memory and memory-mapped screen + keyboard.',
  ...
  },
  {
    ...
    blurb: 'Fetches each instruction and drives the ALU, registers and counter.',
  ...
  },
  {
    ...
    blurb: 'The arithmetic/logic unit and the clocked memory that remembers state.',
  ...
  },
  {
    ...
    io: 'a, b → ¬(a·b)',
    parts: 'one gate',
    blurb: 'A single logic gate — the one primitive taken as given.',
